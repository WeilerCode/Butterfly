    ...
    <div class="row">
        <div class="col-md-4">
            <div class="box box-success">
                ...
                <div class="box-body">
                    <form role="form" action="{{ route('admin-member-group-edit-post', ['id' => $group->id]) }}" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group @if($error = getValidationErrorForTemplate($errors, 'lv')){{ 'has-error' }}@endif">
                            ...
                            <input type="text" class="form-control" name="lv" value="{{ old('lv') ? old('lv') : $group->lv }}" placeholder="等级,数字越大权限越大,必修为整数.">
                            {!! $error !!}
                        </div>
