        ...
        <div class="col-md-4">
            <div class="box box-success">
                <div class="box-header with-border">
                    <a href="{{ route('admin-manage-member') }}" class="btn btn-default btn-sm"><i class="fa fa-reply"></i> {{ getLang('Tips.rollBack') }}</a>
                </div>
                <div class="box-body">
                    <form role="form" action="{{ route('admin-manage-member-edit-post', ['id' => $member->id]) }}" method="post">
    ...
    <div class="modal fade" id="butterfly-cropper-modal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('admin-manage-member-uploadImg') }}" class="butterfly-cropper-form" enctype="multipart/form-data" method="post">
